...
-------------------------------
DBM = {
	Revision = ("$Revision: 5.004 $"):sub(12, -3),
	Version = "5.004",
	DisplayVersion = "5.004 by Gomi/House", -- the string that is shown as version
	ReleaseRevision = 50040 -- the revision of the latest stable version that is available (for /dbm ver2)
}
