...
local timerNextCollapsingStar	= mod:NewTimer(98, "NextCollapsingStar")
...
function mod:OnCombatStart(delay)
	warned_preP2 = false
	warned_star = false
	self:ScheduleMethod(10, "startTimers")	-- schedule timers on combat start, for the case that there's no rp intro like on warmeme
end
